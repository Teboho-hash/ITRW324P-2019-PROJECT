...
@app.route("/lab.env.db", methods=['GET'])
def lab_env_db():
    ...
    for record in temperatures:
        local_timedate = arrow.get(record[0], "YYYY-MM-DD HH:mm"), round(record[2],[2])
...
def to_plotly():
    ...
    from plotly.graph_objs import figure_widget
...
if __name__ == "__main__":
    app.run(host='192.168.137.171', port=3734)
